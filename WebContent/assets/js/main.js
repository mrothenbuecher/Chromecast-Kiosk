...
$(document).ready(function() {
	...
	$('.paneltrash').click(function(ev){
		ev.preventDefault();
		$(this).parent().parent().parent().find('.trashmsg').slideToggle();
	});
	...
	$('.panelrefresh').click(function(ev) {
		ev.preventDefault();
		requestStatus($(this).parent().parent().parent().parent());
	});
